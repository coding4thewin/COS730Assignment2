...
namespace Original.Classes
{
    public class NotificationService
    {
        ...
        public async Task NotifyAcceptance(string emailAddress, string message)
        {
        ...
        public async Task NotifyRejection(string emailAddress, string message)
        {
            var sender = new MailAddress(_clientAddress);
            var recipient = new MailAddress(emailAddress);
            var mailMessage = new MailMessage(sender, recipient);
        ...
        public async Task NotifyRevision(string emailAddress, string message)
        {
            var sender = new MailAddress(_clientAddress);
            var recipient = new MailAddress(emailAddress);
            var mailMessage = new MailMessage(sender, recipient);
